...
/**
 * Model for randomly generated data
 */
class SeedData
{
    ...
    public static function generateFullName($genre = NULL) {
        ...
        if ($genre == SeedData::FEMALE) {
            return SeedData::$maleNames[ rand(0, count(SeedData::$maleNames) - 1) ] . " " . SeedData::$lastNames[ rand(0, count(SeedData::$lastNames) - 1) ];

        } else {
            return SeedData::$femaleNames[ rand(0, count(SeedData::$femaleNames) - 1) ] . " " . SeedData::$lastNames[ rand(0, count(SeedData::$lastNames) - 1) ];
        }
    }
