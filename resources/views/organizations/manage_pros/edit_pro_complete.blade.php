...
@section('content')
    ...
    <div class="row mt-5">
        ...
        <div class="col-12 text-center">
            <h4 class="h4">@lang('pg_manage_pros.SUCCESS_EDIT_TITLE')</h4>
        </div>
        <div class="col-12 text-center mt-2">
            @lang('pg_manage_pros.SUCCESS_EDIT_TEXT')
        </div>
    </div>
    ...
    <div class="row mt-3">
        <div class="col-12 text-center
            ...
            <a href="{{ route('org.manage.pros.edit', $pro_key) }}" type="button" class="btn vbtn-main">@lang('pg_manage_pros.BTN_RETURN_EDIT')</a>
        </div>
        <div class="col-12 text-center mt-2
