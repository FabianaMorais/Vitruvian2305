...
<div class="row justify-content-center">
    <div class="col-auto col-vcenter">
        <h1><i class="vicon-org far fa-building"></i></h1>
    </div>
    <div class="col-auto col-vcenter">
...
<div class="row my-2">
    <div class="col-4 text-right">
        <h6 class="h6 text-muted">@lang('pg_manage_regs.LEADER_NAME'):</h6>
    </div>
    <div class="col-8">
        <h6 class="h6 text-break">{{$user_info->leader_name}}</h6>
    </div>
</div>

<div class="row my-2">
    <div class="col-4 text-right">
        <h6 class="h6 text-muted">@lang('pg_manage_regs.FISCAL_NUMBER'):</h6>
    </div>
    <div class="col-8">
        <h6 class="h6 text-break">{{$user_info->fiscal_number}}</h6>
    </div>
</div>
